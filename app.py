...
def main():
    ...
    st.set_page_config(
        page_title="Automated Wildfire Detection System (AWDS)",
        page_icon="🔥",
    ...
    # App title
    st.markdown("<div class='title'>Automated Wildfire Detection System (AWDS)</div>", unsafe_allow_html=True)
    ...
    <div style='text-align: center;'>
        <h2>🔥 <strong>Automated Wildfire Detection System (AWDS)</strong></h2>
        <p>Welcome to our Automated Wildfire Detection System (AWDS)! Powered by the <a href='https://github.com/ultralytics/ultralytics'>YOLOv8</a> detection model trained on the <a href='https://github.com/gaiasd/DFireDataset'>D-Fire: an image dataset for fire and smoke detection</a>.</p>
